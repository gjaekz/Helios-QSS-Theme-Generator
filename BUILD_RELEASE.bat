...
:: Step 5: Stage the release files in dist\
echo  [5/5]  Copying release files into dist\...

copy /y "INSTALL.txt" "dist\INSTALL.txt" >nul

if errorlevel 1 (
    echo  [ERROR] Failed to copy INSTALL.txt into dist\.
...
echo  [OK] Release files prepared in dist\
echo.
echo  ================================================================
echo   BUILD COMPLETE
echo  ================================================================
...
echo     INSTALL.txt
echo.
echo   Share the files in dist\ directly, or zip that folder manually.
echo   Users can then extract it and double-click the .exe.
echo.
