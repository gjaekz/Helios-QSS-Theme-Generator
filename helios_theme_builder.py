...
class HeliosThemeGenerator(QMainWindow):
    ...
    def _build_ui(self):
        ...
        tbar.setStyleSheet(
            ...
            "stop:0 #0E1016,stop:1 #131820);"
            "border-bottom:1px solid #22242C;")
        tbl = QHBoxLayout(tbar); tbl.setContentsMargins(14,0,14,0); tbl.setSpacing(8)
        tbl.addWidget(self._lbl("⬡", "color:#2CC5D9;font-size:16px;background:transparent;"))
        tbl.addWidget(self._lbl("Helios II  Theme Generator",
            "color:#D0D8E8;font-size:13px;font-weight:700;background:transparent;"))
        tbl.addStretch()
        self._status_lbl = QLabel("")
        self._status_lbl.setStyleSheet("color:#2CC5D9;font-size:10px;background:transparent;min-width:200px;")
    ...
    def _build_sidebar(self):
        ...
        logo.setStyleSheet("color:#2CC5D9;font-size:22px;background:transparent;padding:6px 0 12px 0;")
        sl.addWidget(logo)
...
def main():
    ...
    app.setApplicationName("Helios Theme Generator")
    app.setStyle("Fusion")
